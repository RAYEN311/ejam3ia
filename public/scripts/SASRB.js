...
if(compare_result[j] == true){
    ...
    div.innerHTML = '<div class="equipa" id = " '+ OOP_teams.teams_with_tags[j][0] +' "><div ><img src="https://ejam3ia.cyclic.app/media/imgs/'+ OOP_teams.teams_with_tags[j][0] +'.png" alt="equipe"></div><p style="position:absolute; right : 50vw ; transform:translate(50%)"> '+ OOP_teams.teams_with_tags[j][0] +' </p></div>'
    return div
    }
